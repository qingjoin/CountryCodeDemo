 ...
 *
 */
#define YUNHANZI_START 19968
#define YUNHANZI_COUNT 20902
#include "Yunpinyin.h"
static char firstLetterArray[YUNHANZI_COUNT] = 
...
{
	int index = hanzi - YUNHANZI_START;
	if (index >= 0 && index <= YUNHANZI_COUNT)
	{
